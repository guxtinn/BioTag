"""
Django settings for biotag_project project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-n%251nr&9)sjl)hs8xwcc8faB84ydbb6o=-^n85uhgpv9!+(ey')
...
ROOT_URLCONF = 'biotag_project.urls'
...
WSGI_APPLICATION = 'biotag_project.wsgi.application'
